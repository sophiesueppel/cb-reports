"""
One-time backfill: scrape and rate all BNR speeches from BIS (2021–present).

Run: python backfill_bnr.py
"""
import os
import sys
import time
...
from scraper_bnr import get_all_bnr_speeches, save_rating, DB_PATH
