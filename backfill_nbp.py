"""
One-time backfill: scrape and rate all NBP speeches from BIS (2021–present).

Run: python backfill_nbp.py
"""
import os
import sys
import time
...
from scraper_nbp import get_all_nbp_speeches, save_rating, DB_PATH
...
def main():
    ...
    print(f"=== NBP Backfill: {start_year}–{today.year} ===")
    speeches = get_all_nbp_speeches(start_year=start_year)
